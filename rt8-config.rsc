...
/ip pool
add name=pool1 ranges=172.16.1.100-172.16.1.200
/ip dhcp-server
add address-pool=pool1 interface=ether3 name=server1
/port
set 0 name=serial0
/routing ospf instance
add disabled=no name=default router-id=192.0.0.248
/routing ospf area
add disabled=no instance=default name=backbone
/ip address
add address=192.0.0.248 interface=Lo0 network=192.0.0.248
...
add area=backbone disabled=no networks=\
    192.0.0.248/32,10.1.0.0/24,172.16.1.0/24
/system identity
set name=rt8